...
+---------------------------------+------------------------------------+------------------------------------+------------------------------------+--------------------------------------+----------------------------------------+
| :py:func:`proc_getgroups()`     | :py:func:`proc_getgroups()`        | :py:func:`proc_getgroups()`        | :py:func:`proc_getgroups()`        | :py:func:`proc_getgroups()`          | :py:func:`proc_getgroups()` [1]_ [3]_  |
+---------------------------------+------------------------------------+------------------------------------+------------------------------------+--------------------------------------+----------------------------------------+
...
+---------------------------------+------------------------------------+------------------------------------+------------------------------------+--------------------------------------+----------------------------------------+
| :py:func:`proc_get_sigmasks()`  | :py:func:`proc_get_sigmasks()`     | :py:func:`proc_getsid()` [1]_      | :py:func:`proc_getsid()` [1]_      | :py:func:`proc_getsid()` [1]_        | :py:func:`proc_getsid()` [1]_          |
+---------------------------------+------------------------------------+------------------------------------+------------------------------------+--------------------------------------+----------------------------------------+
|                                 |                                    | :py:func:`proc_get_sigmasks()`     | :py:func:`proc_get_sigmasks()`     |                                      | :py:func:`proc_get_sigmasks()`         |
+---------------------------------+------------------------------------+------------------------------------+------------------------------------+--------------------------------------+----------------------------------------+
...
.. [3] On FreeBSD, calling ``proc_getgroups()`` inside a ``oneshot_proc()`` will first attempt to retrieve
   the group list via a method that collects as much extra information as possible. However, this method may
   truncate the returned group list. In this case, ``proc_getgroups()`` will fall back on the normal method,
